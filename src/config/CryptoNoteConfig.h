...
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 120; //20 min
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(32400000000000);
...
{
    {  0xm1, 0xm2, 0xv1, 0xa1, 0x1m, 0x2m, 0x1v, 0x1a, 0x13, 0x13, 0x14, 0x81, 0x75, 0x19, 0x21, 0x22  }
};
