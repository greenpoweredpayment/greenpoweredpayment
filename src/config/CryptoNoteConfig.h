...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1524331; //gPp
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 80; //20 min
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(130000000000000);
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "015001ff000180c0c8debfc71d0275b797af50219e876530f03b1b0669fe20e2849813cad80d03269f4e5365b56321010c2584d0795bbeaa3964376e2fcbe4b3f856a8a942acfcbf072f118ae6cd505b";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1552515300;
...
const uint32_t MIXIN_LIMITS_V2_HEIGHT                        = 1059840;
const uint32_t MIXIN_LIMITS_V3_HEIGHT                        = 6318720;
...
const char     CRYPTONOTE_NAME[]                             = "GreenPoweredPayment";
...
const int      P2P_DEFAULT_PORT                              =  21314;
const int      RPC_DEFAULT_PORT                              =  21315;
...
{
    {  0xc2, 0xc1, 0xc1, 0xa1, 0x1a, 0x21, 0x19, 0x1a, 0x13, 0x13, 0x14, 0x81, 0x75, 0x19, 0x21, 0x22  }
};
